      ...
      <div class="container padding-top-3x">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
            <div class="from-bottom"><img class="d-inline-block w-150 mb-4" src="/shop/img/hero-slider/logo02.png" alt="Puma">
          ...
          <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="/shop/img/hero-slider/02.png" alt="Puma Backpack"></div>
        </div>
      </div>
    </div>
    <div class="item">
      <div class="container padding-top-3x">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
            <div class="from-bottom"><img class="d-inline-block w-150 mb-3" src="/shop/img/hero-slider/logo01.png" alt="Sony">
          ...
          <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="/shop/img/hero-slider/01.png" alt="Chuck Taylor All Star II"></div>
        </div>
      </div>
    </div>
    <div class="item">
      <div class="container padding-top-3x">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
            <div class="from-bottom"><img class="d-inline-block w-150 mb-3" src="/shop/img/hero-slider/logo03.png" alt="Motorola">
          ...
          <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="/shop/img/hero-slider/03.png" alt="Moto 360"></div>
        </div>
      </div>
    </div>
  </div>
...
<section class="container padding-top-3x padding-bottom-2x">
  <div class="row">
    <div class="col-lg-4 col-sm-6">
      <div class="card border-0 bg-secondary mb-30">
        <div class="card-body d-table w-100">
          <div class="d-table-cell align-middle"><img class="d-block w-100" src="/shop/img/shop/categories/29.png" alt="Image"></div>
    ...
    <div class="col-lg-4 col-sm-6">
      <div class="card border-0 bg-secondary mb-30">
        <div class="card-body d-table w-100">
          <div class="d-table-cell align-middle"><img class="d-block w-100" src="/shop/img/shop/categories/30.png" alt="Image"></div>
          <div class="d-table-cell align-middle pl-2">
    ...
    <div class="col-lg-4 col-sm-6">
      <div class="card border-0 bg-secondary mb-30">
        <div class="card-body d-table w-100">
          <div class="d-table-cell align-middle"><img class="d-block w-100" src="/shop/img/shop/categories/31.png" alt="Image"></div>
          <div class="d-table-cell align-middle pl-2">
  ...
  <div class="row">
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30">
        <div class="product-badge bg-danger">Sale</div><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/01.jpg" alt="Product"></a>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30">
          ...
          </div><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/02.jpg" alt="Product"></a>
        <div class="product-card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30"><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/05.jpg" alt="Product"></a>
        <div class="product-card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30"><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/07.jpg" alt="Product"></a>
        <div class="product-card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30">
          ...
          </div><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/11.jpg" alt="Product"></a>
        <div class="product-card-body">
          <div class="product-category"><a href="#">Headphones</a></div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30">
        <div class="product-badge bg-secondary border-default text-body">Out of stock</div><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/03.jpg" alt="Product"></a>
        <div class="product-card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30"><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/12.jpg" alt="Product"></a>
        <div class="product-card-body">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">     
      <div class="product-card mb-30">
        <div class="product-badge bg-danger">Sale</div><a class="product-thumb" href="shop-single.html"><img src="/shop/img/shop/products/09.jpg" alt="Product"></a>
        <div class="product-card-body">
...
<section class="fw-section padding-top-4x padding-bottom-8x" style="background-image: url(img/banners/shop-banner-bg-02.jpg);"><span class="overlay" style="opacity: .7;"></span>
  <div class="container text-center">
    ...
    <div class="d-inline-block w-200 pt-2"><img class="d-block w-100" src="/shop/img/banners/shop-banner-logo.png" alt="Canon"></div>
    <div class="pt-5"></div>
...
</section><a class="d-block position-relative mx-auto" href="shop-grid-ls.html" style="max-width: 682px; margin-top: -130px; z-index: 10;"><img class="d-block w-100" src="/shop/img/banners/shop-banner-02.png" alt="Printers"></a>
<!-- Staff Picks (Widgets)-->
<section class="container padding-top-3x padding-bottom-2x">
  ...
  <div class="row pt-1">
    <div class="col-md-4 col-sm-6">
      <div class="widget widget-featured-products">
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/01.jpg" alt="Product"></a></div>
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/02.jpg" alt="Product"></a></div>
          <div class="entry-content">
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/03.jpg" alt="Product"></a></div>
          <div class="entry-content">
    ...
    <div class="col-md-4 col-sm-6">
      <div class="widget widget-featured-products">
        ...
        <div class="entry pb-2">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/05.jpg" alt="Product"></a></div>
          <div class="entry-content">
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/04.jpg" alt="Product"></a></div>
          <div class="entry-content">
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/07.jpg" alt="Product"></a></div>
          <div class="entry-content">
    ...
    <div class="col-md-4 col-sm-6">
      <div class="widget widget-featured-products">
        ...
        <!-- Entry-->
        <div class="entry pb-2">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/08.jpg" alt="Product"></a></div>
          <div class="entry-content">
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/09.jpg" alt="Product"></a></div>
          <div class="entry-content">
        ...
        <!-- Entry-->
        <div class="entry">
          <div class="entry-thumb"><a href="shop-single.html"><img src="/shop/img/shop/widget/10.jpg" alt="Product"></a></div>
          <div class="entry-content">
...
<section class="bg-secondary padding-top-3x padding-bottom-3x">
  <div class="container">
    ...
    <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: false, &quot;dots&quot;: false, &quot;loop&quot;: true, &quot;autoplay&quot;: true, &quot;autoplayTimeout&quot;: 4000, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:2}, &quot;470&quot;:{&quot;items&quot;:3},&quot;630&quot;:{&quot;items&quot;:4},&quot;991&quot;:{&quot;items&quot;:5},&quot;1200&quot;:{&quot;items&quot;:6}} }"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/01.png" alt="IBM"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/02.png" alt="Sony"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/03.png" alt="HP"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/04.png" alt="Canon"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/05.png" alt="Bosh"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/06.png" alt="Dell"><img class="d-block w-110 opacity-75 m-auto" src="/shop/img/brands/07.png" alt="Samsung"></div>
  </div>
</section>
<!-- Services-->
<section class="container padding-top-3x padding-bottom-2x">
  <div class="row">
    <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="/shop/img/services/01.png" alt="Shipping">
      <h6 class="mb-2">Free Worldwide Shipping</h6>
      <p class="text-sm text-muted mb-0">Free shipping for all orders over $100</p>
    </div>
    <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="/shop/img/services/02.png" alt="Money Back">
      <h6 class="mb-2">Money Back Guarantee</h6>
      <p class="text-sm text-muted mb-0">We return money within 30 days</p>
    </div>
    <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="/shop/img/services/03.png" alt="Support">
      <h6 class="mb-2">24/7 Customer Support</h6>
      <p class="text-sm text-muted mb-0">Friendly 24/7 customer support</p>
    </div>
    <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="/shop/img/services/04.png" alt="Payment">
