    ...
    <ul>
        ...
        <ul class="sub-menu">
          <li class="active has-children"><a href="index.html">Hero Slider</a>
            <ul class="sub-menu w-400 p-0 overflow-hidden">
              <li><a class="p-0" href="index.html"><img src="/shop/img/banners/home01.jpg" alt="Hero Slider Home"></a></li>
            </ul>
          </li>
          <li class="has-children"><a href="home-featured-categories.html">Categories Grid</a>
            <ul class="sub-menu w-400 p-0 overflow-hidden">
              <li><a class="p-0" href="home-featured-categories.html"><img src="/shop/img/banners/home02.jpg" alt="Categories Grid Home"></a></li>
            </ul>
          </li>
        </ul>
      </li>
      ...
      <li class="has-megamenu"><a href="#">Mega Menu</a>
        <ul class="mega-menu">
          ...
          <li><a class="card border-0 bg-secondary rounded-0" href="shop-grid-ls.html"><img class="d-block mx-auto" alt="Samsung Galaxy S9" src="/shop/img/banners/mega-menu.jpg"></a></li>
        </ul>
      </li>
